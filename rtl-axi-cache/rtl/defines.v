...
`define DS_TO_ES_BUS_WD 218 // br_type由3位编码扩展为6位one-hot，总线宽由217增至220
`define ES_TO_MS_BUS_WD 124
...
//定义地址划分
`define DATA_ADDR_BEGIN 32'h6000_0000
`define DATA_ADDR_END   32'h6FFF_FFFF
`define IO_ADDR_BEGIN   32'h8000_0000
`define IO_ADDR_END     32'h8FFF_FFFF
